...
// https://github.com/AlexZabashta/AggregationMethods/tree/master/src/perm
public class Permutation implements Comparable<Permutation>, Serializable {
	...
	public static Permutation random(int length, Random random) {
		int[] p = new int[length];
		for (int i = 0; i < length; i++) {
			p[i] = i;
			swap(p, i, random.nextInt(i + 1));
		}
